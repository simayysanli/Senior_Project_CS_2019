...
def main():
    ...
    ppo.calc_session_ids(file_names[5], user_id_idx=0, date_idx=1, time_idx=2, time_format='%H:%M:%S',
                         date_format='%Y-%m-%d')
    ppo.filter_page_views(file_names[6], usr_idx=1, sid_idx=0, date_idx=2, time_idx=3, url_idx=4,
